...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["cart-cart-module"], {
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/shop-hour/cart/cart.page.html": function node_modulesRawLoaderDistCjsJsSrcAppShopHourCartCartPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/shop-hour/cart/cart-routing.module.ts": function srcAppShopHourCartCartRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/shop-hour/cart/cart.module.ts": function srcAppShopHourCartCartModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/shop-hour/cart/cart.page.scss": function srcAppShopHourCartCartPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/shop-hour/cart/cart.page.ts": function srcAppShopHourCartCartPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_services_shoup_hour_services_common_ecommerce_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var CartPage = /*#__PURE__*/function () {
      function CartPage(navCtrl, modalController, translate, eComService, uiElementService, apiService) {
          ...
          if (src_models_models_shop_hour_helper_models__WEBPACK_IMPORTED_MODULE_3__["Helper"].getLoggedInUser() != null) {
            if (this.couponCode && this.couponCode.length) {
              this.translate.get(["verifying", "invalid_coupon"]).subscribe(function (values) {
                ...
                _this3.subscriptions.push(_this3.apiService.checkCoupon(_this3.couponCode).subscribe(function (res) {
                  ...
                  if (moment__WEBPACK_IMPORTED_MODULE_5__(res.expires_at).diff(moment__WEBPACK_IMPORTED_MODULE_5__()) > 0) {
                    _this3.couponRes = res;

                    _this3.applyCoupon();
                  } else {
                    _this3.couponRes = null;

                    _this3.uiElementService.presentToast(values["invalid_coupon"]);
                  }
                }, function (err) {
                  _this3.couponCode = "";
                  _this3.couponRes = null;
    ...
    CartPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/shop-hour/cart/cart.page.html"))["default"],
