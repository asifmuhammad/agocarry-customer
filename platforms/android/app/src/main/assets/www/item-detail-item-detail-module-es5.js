...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["item-detail-item-detail-module"], {
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/shop-hour/item-detail/item-detail.page.html": function node_modulesRawLoaderDistCjsJsSrcAppShopHourItemDetailItemDetailPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/shop-hour/item-detail/item-detail-routing.module.ts": function srcAppShopHourItemDetailItemDetailRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/shop-hour/item-detail/item-detail.module.ts": function srcAppShopHourItemDetailItemDetailModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/shop-hour/item-detail/item-detail.page.scss": function srcAppShopHourItemDetailItemDetailPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/shop-hour/item-detail/item-detail.page.ts": function srcAppShopHourItemDetailItemDetailPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_services_shoup_hour_services_common_ui_elements_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    var src_app_services_shoup_hour_services_network_api_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! src/app/services/shoup-hour-services/network/api.service */
    "./src/app/services/shoup-hour-services/network/api.service.ts");
    /* harmony import */


    var src_app_services_shoup_hour_services_common_ecommerce_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    var ItemDetailPage = /*#__PURE__*/function () {
      function ItemDetailPage(route, navCtrl, translate, uiElementService, apiService, eComService) {
      ...
      _createClass(ItemDetailPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.queryParams.subscribe(function (params) {
            ...
            _this3.translate.get(["loading", "something_wrong"]).subscribe(function (values) {
              _this3.uiElementService.presentLoading(values["loading"]);

              _this3.subscriptions.push(_this3.apiService.getProductsWithId(product_id).subscribe(function (res) {
                _this3.product = res;
                _this3.category = _this3.product.categories[0];

                _this3.loadProductsSimilar();
              }, function (err) {
                console.log("getProductsWithId", err);

                _this3.uiElementService.dismissLoading();

                _this3.uiElementService.presentErrorAlert(values["something_wrong"]);
        ...
        value: function loadProductsSimilar() {
          ...
          if (this.product && this.product.vendor_products && this.product.vendor_products.length == 1) {
            this.subscriptions.push(this.apiService.getProductsWithVendorId(this.product.vendor_products[0].vendor_id, 1).subscribe(function (res) {
        ...
        key: "similarsRes",
        value: function similarsRes(prosRes) {
          var index = -1;

          for (var i = 0; i < prosRes.data.length; i++) {
          ...
          this.similarProducts = prosRes.data; // this.doneAll = (!res.data || !res.data.length);
        ...
        key: "similarsErr",
        value: function similarsErr(proError) {
        ...
        value: function addProCart(pro) {
          ...
          if (added) this.cartCount = this.eComService.getCartItemsCount();else this.translate.get("incremented_cart").subscribe(function (value) {
        ...
        value: function toggleFavorite() {
          ...
          if (src_models_helper_models__WEBPACK_IMPORTED_MODULE_8__["Helper"].getLoggedInUser() != null) {
            this.translate.get("just_moment").subscribe(function (value) {
              ...
              _this6.subscriptions.push(_this6.apiService.toggleProductFavorite(_this6.product.id).subscribe(function (res) {
                _this6.product.is_favourite = !_this6.product.is_favourite;
        ...
        key: "navSimilarsAll",
        value: function navSimilarsAll() {
          var navigationExtras = {
            state: {
              category: this.product.categories[0],
              vendors: this.product.vendor_products
            }
          };
    ...
    ItemDetailPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/shop-hour/item-detail/item-detail.page.html"))["default"],
