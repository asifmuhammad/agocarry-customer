...
let ItemPage = class ItemPage {
    ...
    loadProducts() {
        this.subscriptions.push(this.apiService.getProductsWithCategoryId(src_models_constants_models__WEBPACK_IMPORTED_MODULE_5__["Constants"].SCOPE_ECOMMERCE, this.category.id, this.type, this.pageNo).subscribe(res => {
