...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["my-orders-my-orders-module"], {
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/shop-hour/my-orders/my-orders.page.html": function node_modulesRawLoaderDistCjsJsSrcAppShopHourMyOrdersMyOrdersPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/shop-hour/my-orders/my-orders-routing.module.ts": function srcAppShopHourMyOrdersMyOrdersRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/shop-hour/my-orders/my-orders.module.ts": function srcAppShopHourMyOrdersMyOrdersModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _my_orders_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./my-orders-routing.module */
    "./src/app/shop-hour/my-orders/my-orders-routing.module.ts");
    /* harmony import */


    var _my_orders_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./my-orders.page */
    "./src/app/shop-hour/my-orders/my-orders.page.ts");
    ...
    MyOrdersPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_4__["TranslateModule"], _my_orders_routing_module__WEBPACK_IMPORTED_MODULE_6__["MyOrdersPageRoutingModule"]],
  ...
  /***/
  "./src/app/shop-hour/my-orders/my-orders.page.scss": function srcAppShopHourMyOrdersMyOrdersPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/shop-hour/my-orders/my-orders.page.ts": function srcAppShopHourMyOrdersMyOrdersPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var MyOrdersPage = /*#__PURE__*/function () {
      function MyOrdersPage(navCtrl, translate, uiElementService, apiService) {
        var _this3 = this;
      ...
      _createClass(MyOrdersPage, [{
        ...
        value: function ngOnInit() {
          var userMe = src_models_helper_models__WEBPACK_IMPORTED_MODULE_4__["Helper"].getLoggedInUser();
        ...
        value: function getOrders() {
          ...
          this.apiService.getOrders(this.pageNo).subscribe(function (res) {
            if ((!_this4.orders || !_this4.orders.length) && res.data && res.data.length) _this4.registerUpdates();
        ...
        key: "setupOrderProgress",
        value: function setupOrderProgress(order) {
          switch (order.status) {
            case "cancelled":
            case "refund":
            case "hold":
        ...
        key: "toggleOrderExpansion",
        value: function toggleOrderExpansion(order) {
          this.expandedOrderId = Number(this.expandedOrderId == order.id ? -1 : order.id);
        }
      }, {
        key: "navTrackOrder",
        value: function navTrackOrder(order) {
          var _this5 = this;
        ...
        value: function navReviewProduct(order, product) {
          var navigationExtras = {
            state: {
              product: product,
              order_id: order.id
    ...
    MyOrdersPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/shop-hour/my-orders/my-orders.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./my-orders.page.scss */
      "./src/app/shop-hour/my-orders/my-orders.page.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"], src_app_services_shoup_hour_services_common_ui_elements_service__WEBPACK_IMPORTED_MODULE_6__["UiElementsService"], src_app_services_shoup_hour_services_network_api_service__WEBPACK_IMPORTED_MODULE_7__["ApiServiceShopHour"]])], MyOrdersPage);
    /***/
  }
}]);
