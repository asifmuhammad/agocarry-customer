...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["order-tracking-order-tracking-module"], {
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/shop-hour/order-tracking/order-tracking.page.html": function node_modulesRawLoaderDistCjsJsSrcAppShopHourOrderTrackingOrderTrackingPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/shop-hour/order-tracking/order-tracking-routing.module.ts": function srcAppShopHourOrderTrackingOrderTrackingRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/shop-hour/order-tracking/order-tracking.module.ts": function srcAppShopHourOrderTrackingOrderTrackingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_services_network_google_maps_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
  ...
  /***/
  "./src/app/shop-hour/order-tracking/order-tracking.page.scss": function srcAppShopHourOrderTrackingOrderTrackingPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/shop-hour/order-tracking/order-tracking.page.ts": function srcAppShopHourOrderTrackingOrderTrackingPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_services_shoup_hour_services_common_ui_elements_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var OrderTrackingPage = /*#__PURE__*/function () {
      ...
      _createClass(OrderTrackingPage, [{
        ...
        value: function plotMarkers() {
          ...
          markerMe.addListener('click', function (event) {
            return _this7.uiElementService.presentToast(_this7.address.formatted_address);
          });
          var posVendor = new google.maps.LatLng(Number(this.vendor.location.latitude), Number(this.vendor.location.longitude));
          var markerVendor = Object(_assets_scripts_html_map_marker_js__WEBPACK_IMPORTED_MODULE_6__["default"])({
            latlng: posVendor,
            map: this.maps.map,
            html: '<div id="doctor_map"><img src="' + this.vendor.image + '"></div>'
          });
          markerVendor.addListener('click', function (event) {
            return _this7.uiElementService.presentToast(_this7.vendor.name);
          });
          var directionsService = new google.maps.DirectionsService();
          var directionsDisplay = new google.maps.DirectionsRenderer({
            map: this.maps.map,
          ...
          if (this.delivery.delivery.latitude && this.delivery.delivery.longitude) {
            ...
            this.markerDeliveryGuy.addListener('click', function (event) {
              return _this7.uiElementService.presentToast(_this7.delivery.delivery.user.name);
            });
          }
        }
      }, {
    ...
    OrderTrackingPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./order-tracking.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/shop-hour/order-tracking/order-tracking.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./order-tracking.page.scss */
      "./src/app/shop-hour/order-tracking/order-tracking.page.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"], src_app_services_network_google_maps_service__WEBPACK_IMPORTED_MODULE_9__["GoogleMapsService"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_4__["TranslateService"], src_app_services_shoup_hour_services_common_ui_elements_service__WEBPACK_IMPORTED_MODULE_8__["UiElementsService"], _ionic_native_call_number_ngx__WEBPACK_IMPORTED_MODULE_5__["CallNumber"]])], OrderTrackingPage);
    /***/
  }
}]);
