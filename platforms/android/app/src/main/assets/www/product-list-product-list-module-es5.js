...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["product-list-product-list-module"], {
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/product-list/product-list.page.html": function node_modulesRawLoaderDistCjsJsSrcAppProductListProductListPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/product-list/product-list-routing.module.ts": function srcAppProductListProductListRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/product-list/product-list.module.ts": function srcAppProductListProductListModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _product_list_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./product-list.page */
    "./src/app/product-list/product-list.page.ts");
    ...
    ProductListPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_4__["TranslateModule"], _product_list_routing_module__WEBPACK_IMPORTED_MODULE_6__["ProductListPageRoutingModule"]],
  ...
  /***/
  "./src/app/product-list/product-list.page.scss": function srcAppProductListProductListPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/product-list/product-list.page.ts": function srcAppProductListProductListPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ProductListPage = /*#__PURE__*/function () {
      function ProductListPage(router, navCtrl, translate, uiElementService, apiService, eComService) {
        var _this = this;
      ...
      _createClass(ProductListPage, [{
        ...
        value: function loadProducts() {
          ...
          this.subscriptions.push(this.apiService.getProductsWithCategoryId(src_models_constants_models__WEBPACK_IMPORTED_MODULE_8__["Constants"].SCOPE_ECOMMERCE, this.category ? this.category.id : null, this.pageNo).subscribe(function (res) {
